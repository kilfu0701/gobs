// refs on this file... https://github.com/beego/bee/blob/master/bee.go
//
package main
...
var usageTemplate = `gobx is a simply build process.

Usage:
    gobx command [arguments]

The commands are:
{{range .}}{{if .Runnable}}
    {{.Name | printf "%-11s"}} {{.Short}}{{end}}{{end}}

Use "gobx help [command]" for more information about a command.
